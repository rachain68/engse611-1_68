...
1. **ลักษณะ**: มีระบบ middleware ในตัวที่ช่วยจัดการ logic ที่ใช้ซ้ำได้ง่าย

2. **ตัวอย่างใน** `express-server.js`:
...
1. **ข้อดี**: Middleware ทำให้โค้ดสะอาดและจัดการฟังก์ชันที่ใช้ซ้ำได้ง่าย
